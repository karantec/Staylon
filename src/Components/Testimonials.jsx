...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    {
      name: "Tanvi Bansal",
      text: "I had a spa day at Staylon Beauty Parlour, and it was heavenly! The treatments were relaxing, and the staff was incredibly attentive.",
      designation: "Spa Lover",
    },
    {
      name: "Nisha Agarwal",
      text: "The eyebrow shaping service is a must-try! They did an incredible job, and I couldn't be happier with the results.",
      designation: "Beauty Enthusiast",
    },
    {
      name: "Kriti Sen",
      text: "The nail art services are fantastic! I always leave with beautiful nails that last for weeks.",
      designation: "Nail Art Lover",
    },
    {
      name: "Geeta Sharma",
    ...
    {
      name: "Suman Yadav",
      text: "The staff is very attentive and makes sure all your needs are met during your visit. Truly a great experience!",
      designation: "Happy Visitor",
    },
    {
      name: "Anjali Dubey",
      text: "I was impressed by their hygiene practices. It's evident that they prioritize their customers' health and safety.",
      designation: "Health-Conscious Customer",
    },
    {
      name: "Kavita Chatterjee",
      text: "Staylon Beauty Parlour is my favorite place to relax and recharge. The staff always knows how to lift my spirits!",
      designation: "Regular Customer",
    },
    {
      name: "Sonali Khanna",
      text: "The facials are a game-changer! My skin has never looked better after visiting Staylon.",
      designation: "Skincare Addict",
    },
  ];
